...
• Beacon metadata broadcast by APs (advertised AP name, vendor fields, and —
  where an AP advertises it — the AP's own GPS coordinates) — decoded passively
  on-device from frames APs already broadcast; shown as the AP name and included
  in the Beacon sheet of exports (incl. a raw frame hex column). In-memory only;
...
Last updated: 2026-07-02 | AP-Scout Pro v6.0.15
